            ...
            <View style={styles.MainView}>
                ...
                <View style={styles.LottieAnimation}>
                    <View style={styles.LView}>
                        <Text style={{ fontSize: 70, color: "black", fontWeight: "800", justifyContent: "center", marginLeft: 20 }}>78</Text>
                        <Text>hi</Text>
                    </View>
                    <View style={[styles.LottieView, { alignItems: "center" }]}>
                        <Lottie
                            source={require('../../lottiesAnimations/45698-a-cool-boy-standing.json')} autoPlay loop style={{ height: 260, }} />
                    </View>
                </View>
                <View style={{}}>
                    <View style={{ display: "flex", flexDirection: "row", alignItems: "center", alignSelf: "center", marginVertical: 20, borderRadius: 30, paddingHorizontal: 20, backgroundColor: "white" }}>
                ...
                <ScrollView style={{ marginBottom: 80 }}>
                    <View style={styles.PerformanceMainView}>
                        ...
                        <View style={styles.PerformanceImage}>
                            <Image source={{ uri: "https://previews.123rf.com/images/yupiramos/yupiramos1502/yupiramos150206006/36634533-digital-marketing-design-over-white-background.jpg" }} style={{ width: 100, height: 100, color: "white" }} />
                        </View>
                    </View>
                    <View style={styles.PerformanceMainView}>
                        <View style={[styles.PerformanceinnerMainView, { paddingLeft: 10, paddingTop: 10 }]}>
