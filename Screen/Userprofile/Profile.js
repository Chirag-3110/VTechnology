...
function Profile() {
    ...
    return (
        <>
            {
                loading ?
                    <View style={{ height: windowHeight, width: windowWidth, backgroundColor: "white", justifyContent: "center", alignItems: "center" }}>
                        <Lottie
                            source={require('../../lottiesAnimations/110817-account-created.json')} autoPlay loop />
                    </View>
